...
public class ShootBluPlay3 : MonoBehaviour {
	...
	void Update () {
		...
		if (GetComponent<MovBluPlay3> ().isFilled == true) {
			fill = true;
		}
		...
		if (GetComponent<MovBluPlay3> ().faceLeft == true) {
			facingLeft = true;
			facingRight = false;
		}else if (GetComponent<MovBluPlay3> ().faceRight == true) {
			facingRight = true;
			facingLeft = false;
		}
		...
		if (GetComponent<MovBluPlay3> ().balloonPop == false && isShooting == true) {
		...
		if (Input.GetKeyUp (KeyCode.I) || Input.GetKeyUp (KeyCode.O) && isShooting == true) {
		...
		if ((Input.GetKey (KeyCode.I) || Input.GetKey (KeyCode.O)) && fill == true)  {
			
			isShooting = true;
			fill = false;
			GetComponent<MovBluPlay3> ().balloonPop = false;
			
			if (fill == false){
				GetComponent<MovBluPlay3> ().isFilled = false;
			}
		...
		if (Input.GetKeyUp (KeyCode.I) && fill == false) {
		...
		if (Input.GetKeyUp (KeyCode.O) && fill == false) {
